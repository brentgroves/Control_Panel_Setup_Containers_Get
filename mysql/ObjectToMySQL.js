module.exports.ObjectToMySQL = function(params) {
  ...
  console.log('Container_Quantity: ' + ret.Container_Quantity);
  console.log('Default_Printer: ' + ret.Default_Printer);
  if ('' == params.Master_Unit_Key) ret.Master_Unit_Key = null;
  if ('' == params.Workcenter_Printer_Key) ret.Workcenter_Printer_Key = null;
  if ('' == params.Container_Quantity) ret.Container_Quantity = null;
  if ('' == params.Default_Printer_Key) ret.Default_Printer_Key = null;
  if ('' == params.Class_Key) ret.Class_Key = null;
  return ret;
};

//module.exports.FalseToFalse;
